...
namespace model
{
    namespace internal
    {
        static void update_transition (size_t *animation_indices, float *animation_weights, float *transition_delta, size_t anim_index, float delta)
        {
        ...
        static void update_transition_animation (float *current_time, glm::mat4 *joints, glm::mat4 *joints_buffer, size_t joint_count, Skin *skin, SkinAnimation *anim, size_t *animation_indices, float *animation_weights, float *transition_delta, float delta)
        {
    ...
    static void update_transition (SkinTransitionAnimator &ator, size_t anim_index, float delta)
    {
        internal::update_transition(ator.animation_indices, ator.animation_weights, &ator.transition_delta, anim_index, delta);
    }

    static void update_transition_animation (SkinTransitionAnimator &ator, float delta)
    {
    ...
    static SkinTransitionAnimator create_skin_transition_animator (Skin *skin, SkinAnimation *anim, size_t animation_count)
    {
