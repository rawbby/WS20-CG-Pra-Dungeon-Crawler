...
namespace model
{
    namespace internal
    {
        static void update_joints (glm::mat4 *joints, size_t joint_count, Skin *skin, SkinAnimation *anim, size_t i0, size_t i1, float delta)
        {
        ...
        static void update_animation (float &current_time, glm::mat4 *joints, size_t joint_count, Skin *skin, SkinAnimation *anim, float delta)
        {
            current_time += delta;
    ...
    static SkinAnimator create_skin_animator (Skin *skin, SkinAnimation *anim)
    {
