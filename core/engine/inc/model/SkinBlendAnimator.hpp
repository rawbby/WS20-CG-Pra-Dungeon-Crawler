...
namespace model
{
    ...
    {
        //@formatter:off
        static void update_blend_animation (float *current_time,
    ...
    static void update_blend_animation (SkinBlendAnimator ator, float delta)
    {
        //formatter:off
        internal::update_blend_animation(ator.current_time, ator.joints, ator.joints_buffer, ator.joint_count, ator.skin, ator.anim, ator.animation_indices, ator.animation_weights, delta);
        //formatter:on
    }

    static SkinBlendAnimator create_skin_blend_animator (Skin *skin, SkinAnimation *anim, size_t animation_count)
    {
